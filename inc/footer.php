    <footer class="p-4 bg-[#F2F0F1] xl:flex xl:flex-col xl:items-start xl:justify-center xl:px-24 xl:pt-14">
        <div class="xl:flex xl:items-start xl:justify-evenly xl:w-full">
            <div class="xl:flex xl:flex-col xl:items-start">
                <h1 class="font-bebas font-bold text-6xl mt-1 xl:m-0">SHOP.CO</h1>
                <p class="opacity-60 xl:w-80">
            ...
            <div class="grid grid-cols-2 gap-y-8 w-full xl:flex xl:items-start xl:justify-around">
                <div>
